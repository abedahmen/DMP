...
$insertQuery = "INSERT INTO visite_radio (id_radio, patient_id, id, date) VALUES (?, ?, ?, ?)";
...
$stmt->bind_param("iiis", $id_radio, $patientId, $medecinId, $date);

// Itération sur les médicaments sélectionnés
foreach ($selectedMedicaments as $id_radio) {
