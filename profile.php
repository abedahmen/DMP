    ...
    <main>
        <div class="container">
            <div>
                ...
                <?php } ?>
                <form  method="POST">
                    <input class="nom" type="text" id="nom" name="nom" placeholder="Entrez votre nom" required>
                    <input class="motdepasse" type="password"  id="motdepasse" name="motdepasse" placeholder="Tapez votre mot de passe" required>
