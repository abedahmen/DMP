...
// Requête pour sélectionner les données de la table 'radio'
$query = "SELECT id_radio, nom_radio FROM radio";
...
#retourButton:hover {
  ...
  <h1>Choisir les Radios</h1>

  <center>
    <div class="searchResults">
      <input type="text" id="searchInput" placeholder="Rechercher des Radios">
      <ul id="searchResultsList">
        <?php foreach ($data as $row): ?>
          <li class="searchResultItem" data-id="<?php echo $row['id_radio']; ?>"><?php echo $row['nom_radio']; ?></li>
        <?php endforeach; ?>
      </ul>
    </div>

    <div class="selectedMedicaments">
      <h2>Radios sélectionnés</h2>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#validerButton').on('click', function() {
        ...
        $.post('tret_radio.php', { selectedMedicaments: selectedMedicaments , patient_id:patient_id ,id_medecin:id_medecin , date:date })
        .done(function(data) {
